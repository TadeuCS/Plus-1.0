 ...
 * @author Tadeu
 */
public class Cad_Locação extends javax.swing.JFrame {

    /**
     * Creates new form Cad_Locação
     */
    public Cad_Locação() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cad_Locação.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Cad_Locação().setVisible(true);
            }
        });
    }
